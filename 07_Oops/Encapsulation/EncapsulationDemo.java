...
public class EncapsulationDemo {
    public static void main(String[] args) {
         ...
         * h1.age = 11;
         * 
         * Since these are private variable these are not accessable from this class, if
         * we want to access them wehave to go the same class
         */
...
/*
 * Encapsulation Encapsulation is a way to restrict the direct access to some
 * components of an object,
 * so users cannot access state values for all of the variables of a particular
 * object
 */